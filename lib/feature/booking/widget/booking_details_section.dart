          ...
          return SingleChildScrollView( physics: const ClampingScrollPhysics(), child: Center(
            child: Padding( padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                ...
                const SizedBox(height: Dimensions.paddingSizeLarge),
                bookingDetails.provider != null ? ProviderInfo(provider: bookingDetails.provider!, bookingId: bookingDetails.id!) : const SizedBox(),
                const SizedBox(height: Dimensions.paddingSizeSmall),

                bookingDetails.serviceman != null ? ServiceManInfo(user: bookingDetails.serviceman!.user!, bookingId: bookingDetails.id!, userId: bookingDetails.serviceman!.userId!) : const SizedBox(),
                const SizedBox(height: Dimensions.paddingSizeDefault),
