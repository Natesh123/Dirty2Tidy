  ...
  Widget build(BuildContext context) {
    return Center(child: Container( width: Dimensions.webMaxWidth,
      ...
      child: Row(children: [
        ...
        MenuButtonWeb( title: 'Categories', onTap: (){
          if (kDebugMode) {
            print("DEBUG: Categories menu button clicked!");
          }
          _closeSearchDialog();
          Get.find<AllSearchController>().clearSearchController();
          if(Get.find<LocationController>().getUserAddress() != null){
            Get.toNamed(RouteHelper.getCategoryRoute('category', 'null'));
          }else{
          ...
          return cartController.cartList.isNotEmpty ? Positioned( top: -7, right: -7,
            child: Container(
              ...
              child: FittedBox(child: Text(
                cartController.cartList.map((e) => e.serviceId).toSet().length.toString(),
