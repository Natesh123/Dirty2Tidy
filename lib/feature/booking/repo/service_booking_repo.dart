...
class ServiceBookingRepo{
  ...
  Future<Response> updateBookingSchedule({required String bookingId, required String schedule}) async {
    return await apiClient.putData("${AppConstants.bookingScheduleUpdate}/$bookingId", {'schedule': schedule, 'guest_id':  Get.find<SplashController>().getGuestId()});
  }
