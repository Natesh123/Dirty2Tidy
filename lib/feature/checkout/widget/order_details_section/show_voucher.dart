                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                          onTap: () {
                            double totalAmount = CheckoutHelper.calculateTotalAmountWithoutCoupon(cartList: cartController.cartList);
                            if(ResponsiveHelper.isDesktop(context)) {
                              Get.dialog(Center(child: CouponBottomSheetWidget(orderAmount: totalAmount)));
                            } else {
                              showModalBottomSheet(context: context,
                                  isScrollControlled: true, backgroundColor: Colors.transparent,
                                  builder: (c) => CouponBottomSheetWidget(orderAmount: totalAmount)
                              );
                            }
                          },
