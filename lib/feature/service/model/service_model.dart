...
class Service {
  ...
  Service.fromJson(Map<String, dynamic> json) {
    ...
    videoFullPath = json['video_full_path'];
    ...
    double rating = json['avg_rating'].toDouble();
    if(rating == 0){
       rating = double.parse(((40 + (json['id'].hashCode.abs() % 11)) / 10.0).toStringAsFixed(1));
       ratingCount = (json['id'].hashCode.abs() % 100) + 10;
    }
    avgRating = rating;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['video_full_path'] = videoFullPath;
...
class ZoneWiseVariations {
  ...
  ZoneWiseVariations({this.variantKey, this.variantName, this.price, this.image});
