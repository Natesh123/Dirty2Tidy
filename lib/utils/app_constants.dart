...
class AppConstants {
  ...
  static const String appName = 'Dirt2Tidy';
  ...
  static const String categoryUrl = '/api/v1/customer/category?limit=100';
  ...
  static const String bookingScheduleUpdate = '/api/v1/customer/booking/schedule-update';
  ...
  static const String promotionalVideoUri = '/api/v1/customer/promotional-video';
  static const String serviceRequestUri = '/api/v1/customer/service/request';
  static const String addLead = '/api/v1/customer/lead/store';
