...
class ConversationListView extends StatelessWidget {
  ...
  final int tabIndex;
  const ConversationListView({super.key, required this.channelList, required this.tabIndex}) ;
    ...
    return GetBuilder<ConversationController>(builder: (conversationController){
      ...
      RefreshIndicator(
        ...
        child: ListView.builder(
          controller: Get.find<ConversationController>().channelScrollController1,
          shrinkWrap: true,
