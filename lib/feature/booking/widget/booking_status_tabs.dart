            ...
            child: ResponsiveHelper.isDesktop(context) ? Column(
              ...
              children: [
                ...
                Row( mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                  ...
                  Padding( padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeEight),
                    child: Wrap(alignment: WrapAlignment.center, children: serviceBookingController.displayBookingStatusTabs.map((e) {
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  itemCount: serviceBookingController.displayBookingStatusTabs.length,
                  scrollDirection: Axis.horizontal,
                  itemBuilder: (context,index){
                    return GetBuilder<ServiceBookingController>(builder: (controller){
                      return InkWell(
                        child: BookingStatusTabItem(
                          title: controller.displayBookingStatusTabs.elementAt(index).name,
                        ),
                        onTap: (){
                          controller.updateBookingStatusTabs(controller.displayBookingStatusTabs.elementAt(index));
                        },
                      );
                    });
                  },
