                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if(['popular_services', 'trending_services', 'recently_view_services'].contains(fromPage) && service.category?.name != null)
                          Text(
                         ...
                         RatingBar(rating: service.avgRating, size: 12, ratingCount: service.ratingCount),
                      ],
                    ),
                  ),

                  (fromPage == 'all_service' && ResponsiveHelper.isDesktop(context)) ? const SizedBox() : Expanded(
                    flex: 3,
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
