                                            ...
                                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              ...
                                              Expanded( flex:1,
                                                child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                                                  index == 0 ? const SizedBox() : // Hide decrement for first item
                                                  ...
                                                  index == 0 ? Text( // Show static quantity for first item
                                                  ...
                                                  index == 0 ? const SizedBox() : // Hide increment for first item
                                                  GestureDetector(
                                                    onTap: (){
