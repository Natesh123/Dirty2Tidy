...
class AuthController extends GetxController implements GetxService {
  ...
  void onInit() {
    super.onInit();
    countryDialCode = CountryCode.fromCountryCode(Get.find<SplashController>().configModel.content != null ? Get.find<SplashController>().configModel.content!.countryCode!:"AU").dialCode!;
  }
  ...
  void initCountryCode({String? countryCode}){
    countryDialCode = countryCode ?? CountryCode.fromCountryCode(Get.find<SplashController>().configModel.content?.countryCode ?? "AU").dialCode ?? "+61";
  }
}